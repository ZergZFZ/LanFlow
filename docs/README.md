# LanFlow 文档索引（linux 分支）

> 查看项目情况：先读本索引 + [LanFlow-Linux基线.md](LanFlow-Linux基线.md) + [LanFlow-缺陷板与修复冲刺计划.md](LanFlow-缺陷板与修复冲刺计划.md)。
> 归档文档不参与日常阅读；需要时按 archive/ 目录或 git 历史查阅。
...
| archive/Win11-Shadow-Fix.md | 归档 | Windows 旧迭代：Win11 阴影修复 |
